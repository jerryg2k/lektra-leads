...
import { BarChart3, Building2, Kanban, Layers, LogOut, PanelLeft, Plus, Radio, ScanLine, Search, Settings, Upload } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Layers, label: "Batch Scan", path: "/batch-scan" },
          ...
          <div className="flex border-b h-14 items-center justify-between bg-background/95 px-2 backdrop-blur supports-[backdrop-filter]:backdrop-blur sticky top-0 z-40">
            <div className="flex items-center gap-2">
              <div className="relative">
                ...
                {overdueCount > 0 && (
                  <span className="absolute -top-1 -right-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-red-500 px-0.5 text-[9px] font-bold text-white pointer-events-none">
                    {overdueCount > 99 ? "99+" : overdueCount}
                  </span>
                )}
              </div>
